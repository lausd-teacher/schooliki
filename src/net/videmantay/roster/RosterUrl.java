package net.videmantay.roster;
 ...
 public class  RosterUrl {
	...
	public final static String GET_ROSTER ="/teacher/getroster";
	
	public final static String CREATE_ASSIGNMENT="/teacher/createassignment";
	public final static String DELETE_ASSIGNMENT="/teacher/deleteassignment";
	public final static String UPDATE_ASSIGNMENT="/teacher/updateassignment";
	...
	public final static String GET_CLASSTIME ="/teacher/getclasstime";
	public final static String LIST_CLASSTIME="/teacher/listclasstime";
	public final static String CREATE_CLASSTIME="/teacher/createclasstime";
	public final static String UPDATE_CLASSTIME="/teacher/updatesclasstime";
	public final static String DELETE_CLASSTIME="/teacher/deleteclasstime";
